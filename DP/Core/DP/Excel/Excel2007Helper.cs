...
namespace DP.Excel
{
    public class Excel2007Helper : ExcelHelper
    {
        ...
        public override DataTable ExcelToDataTable(string fileName, string sheetName)
        {
            ...
            using (FileStream fs = new FileStream(fileName, FileMode.Open, FileAccess.Read))
            {
                ...
                {
                    sheetIndex = xssfworkbook.GetSheetIndex(sheetName);
                }
                ...
                {
                    object obj = GetValueType(header.GetCell(i) as XSSFCell);
                ...
                for (int i = sheet.FirstRowNum + 1; i <= sheet.LastRowNum; i++)
                {
                    ...
                    {
                        dr[j] = GetValueType(sheet.GetRow(i).GetCell(j) as XSSFCell);
